  ...
  useEffect(() => {
    const loadScheduleData = async () => {
      try {
        ...
        // Extract unique classes from teachers
        teachers.forEach(teacher => {
          const programa = teacher['Πρόγραμμα'] || teacher['πρόγραμμα'] || teacher['Μαθήματα'];
          if (programa) {
            days.forEach(day => {
              ...
              if (daySchedule) {
                Object.values(daySchedule).forEach(subject => {
                  if (subject && subject.trim() !== '-') {
                    const classMatch = subject.match(/([ΑΒΓ][0-9]{2})/g);
                    if (classMatch) {
                      classMatch.forEach(cls => classesSet.add(cls));
                    }
                  }
                });
              }
        ...
        for (const className of classes) {
          schedule[className] = await buildClassSchedule(teachers, students, classrooms, className);
        }
        ...
        <div className="p-6 border-b bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-sm text-gray-500">Σχολική Χρονιά 2024-25</div>
      ...
      <div className="mb-8">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 text-lg">
            Ωράριο Τμημάτων Α', Β', Γ' Λυκείου - Σχολική Χρονιά 2024-25
          </p>
        </div>
